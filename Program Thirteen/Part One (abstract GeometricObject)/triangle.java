...
public class triangle extends GeometricObject{
    ...
    private double side1 = 1;   //holds the side1 data and defaults to 1
    private double side2 = 1;   //holds the side2 data and defaults to 1
    private double side3 = 1;   //holds the side3 data and defaults to 1
    ...
    //gets the area of a triangle. Overides the function in GeometricObject 
    @Override
    ...
    //gets the perimeter of a triangle. Overides the function in GeometricObject 
    @Override
    ...
    //displays the info about a triangle. Overides the function in GeometricObject 
    @Override
    public String toString()
    {
        return "Triangle:\nArea: " + String.format("%.2f", getArea()) + "\nPerimeter: " + 
                String.format("%.2f", getPerimeter()) + super.toString();
    }
